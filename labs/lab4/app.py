...
def create_app() -> Flask:
    ...
    # ВАЖНО: x_prefix=1 чтобы Flask корректно видел /lab4 из X-Forwarded-Prefix
    ...
    def _next_url_current_page():
        # Всегда добавляем префикс /lab4 для корректного next под nginx
        return "/lab4" + request.path
    ...
    def login():
        ...
        if request.method == "POST":
            ...
            if nxt and nxt.startswith("/") and not nxt.startswith("/lab4/"):
                nxt = "/lab4" + nxt
